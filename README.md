...
This application is a deeplearning application specifically tuned ideally for the classification of car titles using machine learning. 
The model can take different parameters in terms of batch size, the data's location, and finally the model location.
